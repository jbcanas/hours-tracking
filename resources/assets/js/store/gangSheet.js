export default {
	state: {
		...
		accountDescriptions: [
			{
			    value: 'BARGES',
			    jobNames: ['NORTHLAND', 'IMPALA', 'NL SUPPORT', 'HORIZON', 'HORIZON SUPPORT', 'SEA TRADER', 'SEA TRADER SUPPORT', 'SAMSON', 'SAMSON SUPPORT']
			},
			{
			    value: 'CFS SURVEY',
			    jobNames: ['DELTA WESTERN - CAST OFF', 'DELTA WESTERN - TIE UP', 'DELTA WESTERN - SECURITY', 'DELTA WESTERN - GANG', 'SHELL - CAST OFF', 'SHELL - TIE UP', 'SHELL - SECURITY', 'SHELL - GANG', 'NORTHLAND', 'HORIZON', 'SEA TRADER', 'SAMSON', 'TRAINING', 'MISCELLANEOUS', 'WHIRLY CRANE', 'HORIZON TIE-UP', 'HORIZON CAST-OFF', 'HORIZON GANG', 'HORIZON SECURITY', 'HORIZON LINES SHIFT']
			},
			{
			    value: 'CFS BARGES',
			    jobNames: 'CFS BARGES'
			...
			},
			{
			    ...
			    jobNames: ['CORD ROLLERS', 'CONTAINER YARD CLEAN-UP', 'CRANE MAINTENANCE', 'DOCK WASHING', 'REEFER WASHING', 'SNOW REMOVAL', 'MISCELLANEOUS', 'VEHICLE WASHING']
			},
			{
			    value: 'DD YARD DAWG',
			    jobNames: 'YARD DAWG'
			...
			},
			{
			    ...
			    jobNames: ['HORIZON SUPPORT', 'NL SUPORT', 'SAMSON SUPPORT', 'SEA TRADER SUPPORT', 'YARD SORT', 'YARD WORK', 'YARD WORK/OTHER']
			}
		],
		jobNames: [
			'NORTHLAND', 'BARGE', 'NL SUPPORT', 'DELIVERY', 'HORIZON', 'GH-DISPATCH', 'HORIZON SUPPORT', 'CAST-OFF', 'SEA TRADER', 'CLERICAL', 'SEA TRADER SUPPORT', 'CRANE WORK', 'CRANE MAINTENANCE', 'SAMSON', 'TOOL ALLOWANCE', 'DOCK WASHING', 'SAMSON SUPPORT', 'EDUC', 'DELTA WESTERN - CAST OFF', 'SHELL - CAST OFF', 'TIE-UP', 'DELTA WESTERN - TIE UP', 'SHELL - TIE UP', 'LONGSHORE', 'DELTA WESTERN - SECURITY', 'SHELL - SECURITY', 'LTL', 'DELTA WESTERN - GANG', 'SHELL - GANG', 'ROAD DRIVING', 'SHOP DISPATCHER', 'SECURITY', 'IMPALA', 'SHUFFLE', 'SNOW REMOVAL', 'STEADYMEN', 'MISCELLANEOUS', 'TRAINING', 'DISPATCHER', 'CORD ROLLERS', 'TRANSLOADS', 'CONTAINER YARD CLEAN-UP', 'YARD DRIVING', 'UNPIN CRANE', 'REEFER WASHING', 'VESSEL', 'VESSEL SUPPORT', 'YARD DAWG', 'VEHICLE WASHING', 'YARD WORK', 'BOBCAT', 'YARD SORT', 'CRANE', 'BASIC LONGSHORE', 'DRIVER', 'DISCRIMINATION', 'FALL AREST', 'TRAINING COMMITTEE', 'FIRST AID', 'FORKLIFT', 'HAZMAT DRIVER', 'HATCH/DOCK TENDER', 'LOADER', 'MAN OVERBOARD', 'STRENGTH & AGILITY', 'TOPPICK', 'SHIP GANG', 'SHIP TIE-UP', 'SHIP CAST-OFF', 'SHIP LASHERS', 'REEFER MECHANICS', 'SHOP-MECHANICS', 'SHOP-TEMP', 'NL SUPORT', 'YARD WORK/OTHER', 'HORIZON TIE-UP', 'HORIZON CAST-OFF', 'HORIZON GANG', 'HORIZON SECURITY', 'HORIZON LINES SHIFT', 'ORIENTATION'
		],
		find: {
			ilwu: false,
			value: ''
